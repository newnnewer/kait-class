<?php
/* lessons.php — 학생에게 보이는 수업 목록 */
declare(strict_types=1);
require_once __DIR__ . '/guard.php';
require_once __DIR__ . '/layout.php';
$u = need_login();

$sets = sets_for_student($u, 'lesson');
...
page_head(['title' => '수업', 'root' => '', 'user' => $u, 'nav' => 'lessons']);
?>
<div class="wrap narrow">
  <div class="phead">
    <h1>수업</h1>
    <span class="sub">참여할 수업을 고르세요.</span>
  </div>

  <?php if (!$sets): ?>
    <div class="empty">아직 열린 수업이 없습니다.</div>
  <?php else: ?>
    <?php if ($live): ?>
      <div class="setlist">
    ...
    <?php else: ?>
      <div class="empty">진행 중인 수업이 없습니다.</div>
    <?php endif; ?>

    <?php if ($done): ?>
      <details class="donebox"<?= $live ? '' : ' open' ?>>
        <summary>종료된 수업 <?= count($done) ?>개 보기</summary>
        <div class="setlist">
